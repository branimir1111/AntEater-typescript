...
const SmallSidebar = ({ setOpenSmallSidebar }: SmallSidebarProps) => {
  return (
    <section className="w-full bg-[url('./images/SmallSidebarBG.svg')] absolute flex flex-col items-center top-0 min-h-screen z-20 py-8 px-4 lg:hidden bg-no-repeat bg-cover">
