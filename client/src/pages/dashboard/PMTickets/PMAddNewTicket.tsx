...
type PMAddNewTicketProps = {
  allPMProjects: ProjectResponse[];
};

const PMAddNewTicket = ({ allPMProjects }: PMAddNewTicketProps) => {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px] bg-background-first">
        ...
        <Form method="post" action="/dashboard/manager-ticket/add-pm-ticket">
          <FormInput
            name="title"
            type="text"
            label="Title"
